...
const textTranslations = {
  ...
  '01 / QMN DEVNET TEST SATIŞI': '01 / QMN DEVNET TEST SALE', '0,1 SOL = 9.950 QMN · 1 SOL = 99.500 QMN · 10 SOL = 9.950.000 QMN.': '0.1 SOL = 9,950 QMN · 1 SOL = 99,500 QMN · 10 SOL = 9,950,000 QMN.',
...
function getQmnRate(amount) {
  const rate = presaleTiers.find((tier) => amount >= tier.minimum)?.rate || presaleTiers[0].rate;
  return rate;
}
